...
If you aspire one day to become a Node.js architect (or maybe you're already one and want to extend your knowledge), this presentation is for you.`,
  ...
  */
  handleSubmit(event) {
    ...
    fetch(this.props['data-url'], { method: 'POST', body: JSON.stringify(this.state), mode: 'no-cors' }).then(response => {
  ...
  render() {
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement("input", { type: "text", name: "new-book-title", readOnly: true, defaultValue: "Node: The Best Parts" }),
        ...
        React.createElement(
          "select",
          { name: "langSelect", value: this.state.selectedValue, onChange: this.handleSelectChange },
          React.createElement(
            "option",
            { value: "ruby" },
            "Ruby"
        ...
        React.createElement(
          "select",
          { name: "libSelect", multiple: true, value: this.state.selectedMultiValues, onChange: this.handleMultiSelectChange },
          this.multiOptions.map(el => {
            return React.createElement(
              "option",
              { value: el },
              Content.upperCaseIt(el)
            );
          })
        ),
        React.createElement("hr", null),
